# Research packet: Shirdi, Maharashtra

_Generated 2026-06-22. Evidence-backed prompts only; no invented local facts._

## Identity
- State: Maharashtra (`MAHARASHTRA`)
- Constituency: Shirdi (`SHIRDI`)

## Election facts (2019 → 2024)
- Winner 2019: SADASHIV KISAN LOKHANDE
- Winner 2024: BHAUSAHEB RAJARAM WAKCHAURE
- Party 2019: SHS
- Party 2024: SHSUBT
- Winner changed: True
- BJP vote share 2019: None
- BJP vote share 2024: None
- INC vote share 2019: 35.6167
- INC vote share 2024: 0.0
- BJP swing: None
- INC swing: -35.6167
- Margin 2019: 11.6767
- Margin 2024: 4.7675
- Margin change: -6.9092
- Turnout 2019: 30.674
- Turnout 2024: 28.39
- Turnout change: -2.284
...
- winner_2024: BHAUSAHEB RAJARAM WAKCHAURE
- winner_party_2024: SHSUBT
- data_quality_label: election_only
- projection_confidence_hint: high

## Existing analysis
- analysis_source: generated
- generated summary: Shirdi flipped from SHS to SHSUBT in 2024. INC vote share changed by -35.6 points compared with 2019. The 2024 margin was 4.8%. This is a descriptive election profile, not a causal explanation.
- generated movement: Available data indicates Shirdi flipped from SHS to SHSUBT between 2019 and 2024. INC vote share changed by -35.6 percentage points versus 2019. The winning margin moved from 11.7% in 2019 to 4.8% in 2024. Turnout changed by -2.3 percentage points between 2019 and 2024. This section describes observed election movement only and is not a causal explanation.
- has manual markdown: False

## Writing prompts

- **what_happened_prompt**: Describe observed 2019→2024 election movement for Shirdi, Maharashtra using winner, vote-share, margin, and turnout fields only.
- **why_it_mattered_prompt**: Explain why Shirdi may be analytically useful using priority reason (seat_flip;top_inc_loss), contest closeness, swings, and state context.
