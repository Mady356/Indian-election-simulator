# Research packet: Jhanjharpur, Bihar

_Generated 2026-06-22. Evidence-backed prompts only; no invented local facts._

## Identity
- State: Bihar (`BIHAR`)
- Constituency: Jhanjharpur (`JHANJHARPUR`)

## Election facts (2019 → 2024)
- Winner 2019: Ramprit Mandal
- Winner 2024: RAMPRIT MANDAL
- Party 2019: JDU
- Party 2024: JDU
...
- Margin 2019: 30.4509
- Margin 2024: 16.8384
- Margin change: -13.6125
- Turnout 2019: 32.5192
- Turnout 2024: 26.58
- Turnout change: -5.9392
...
- electricity_pct_nfhs5: 65.8411
- improved_sanitation_pct_nfhs5: 31.6823
- lpg_pct_nfhs5: 14.6029
- mobile_phone_pct_nfhs5: 0.0
- bank_account_pct_nfhs5: 48.7617
- wealth_index_mean_nfhs5: -59647.1606
- urban_pct_nfhs5: 14.6029
- nfhs5_coverage_share: 1.0
- change_coverage_share: 1.0
- change_quality_flag: low
- districts_used: MADHUBANI→Madhubani
- districts_missing: N/A

## Simulation context
- simulation_completeness: full_party_shares
- winner_2024: RAMPRIT MANDAL
...
- generated summary: Jhanjharpur was retained by JDU in 2024. Vote-share swing data are limited for this seat. The 2024 margin was 16.8%. This is a descriptive election profile, not a causal explanation.
- generated movement: Available data indicates Jhanjharpur was retained by JDU in 2024. The winning margin moved from 30.5% in 2019 to 16.8% in 2024. Turnout changed by -5.9 percentage points between 2019 and 2024. This section describes observed election movement only and is not a causal explanation.
- has manual markdown: False

## Writing prompts

- **what_happened_prompt**: Describe observed 2019→2024 election movement for Jhanjharpur, Bihar using winner, vote-share, margin, and turnout fields only.
- **why_it_mattered_prompt**: Explain why Jhanjharpur may be analytically useful using priority reason (none), contest closeness, swings, and state context.
