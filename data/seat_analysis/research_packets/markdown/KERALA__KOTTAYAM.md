# Research packet: Kottayam, Kerala

_Generated 2026-06-22. Evidence-backed prompts only; no invented local facts._

## Identity
- State: Kerala (`KERALA`)
- Constituency: Kottayam (`KOTTAYAM`)

## Election facts (2019 → 2024)
- Winner 2019: Thomas Chazhikadan
- Winner 2024: ADV K FRANCIS GEORGE
- Party 2019: KEC(M)
- Party 2024: KEC
- Winner changed: True
...
- Margin 2019: 11.6725
- Margin 2024: 10.4357
- Margin change: -1.2367
- Turnout 2019: 34.8924
- Turnout 2024: 29.03
- Turnout change: -5.8624
...
- improved_sanitation_pct_nfhs5: 36.6136
- lpg_pct_nfhs5: 26.0651
- mobile_phone_pct_nfhs5: 19.947
- bank_account_pct_nfhs5: 31.3394
- wealth_index_mean_nfhs5: 14782.4405
- urban_pct_nfhs5: 25.2212
- nfhs5_coverage_share: 1.0
- change_coverage_share: 1.0
- change_quality_flag: low
- districts_used: Ernakulam→Ernakulam; Palakkad→Palakkad
- districts_missing: N/A

## Simulation context
- simulation_completeness: full_party_shares
- winner_2024: ADV K FRANCIS GEORGE
- winner_party_2024: KEC
- data_quality_label: high
- projection_confidence_hint: high

## Existing analysis
- analysis_source: generated
- generated summary: Kottayam flipped from KEC(M) to KEC in 2024. Vote-share swing data are limited for this seat. The 2024 margin was 10.4%. This is a descriptive election profile, not a causal explanation.
- generated movement: Available data indicates Kottayam flipped from KEC(M) to KEC between 2019 and 2024. The winning margin moved from 11.7% in 2019 to 10.4% in 2024. Turnout changed by -5.9 percentage points between 2019 and 2024. This section describes observed election movement only and is not a causal explanation.
- has manual markdown: False

## Writing prompts

- **what_happened_prompt**: Describe observed 2019→2024 election movement for Kottayam, Kerala using winner, vote-share, margin, and turnout fields only.
- **why_it_mattered_prompt**: Explain why Kottayam may be analytically useful using priority reason (seat_flip), contest closeness, swings, and state context.
