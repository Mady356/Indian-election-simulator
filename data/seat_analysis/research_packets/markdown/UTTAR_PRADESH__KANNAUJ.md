# Research packet: Kannauj, Uttar Pradesh

_Generated 2026-06-22. Evidence-backed prompts only; no invented local facts._

## Identity
- State: Uttar Pradesh (`UTTAR PRADESH`)
- Constituency: Kannauj (`KANNAUJ`)

## Election facts (2019 → 2024)
- Winner 2019: SUBRAT PATHAK
- Winner 2024: AKHILESH YADAV
- Party 2019: BJP
- Party 2024: SP
- Winner changed: True
- BJP vote share 2019: 49.3721
- BJP vote share 2024: 38.7056
...
- Margin 2019: 1.0831
- Margin 2024: 14.0349
- Margin change: 12.9518
- Turnout 2019: 30.0341
- Turnout 2024: 32.22
- Turnout change: 2.1859
...
- generated summary: Kannauj flipped from BJP to SP in 2024. BJP vote share changed by -10.7 points compared with 2019. The 2024 margin was 14.0%. This is a descriptive election profile, not a causal explanation.
- generated movement: Available data indicates Kannauj flipped from BJP to SP between 2019 and 2024. BJP vote share changed by -10.7 percentage points versus 2019. The winning margin moved from 1.1% in 2019 to 14.0% in 2024. Turnout changed by +2.2 percentage points between 2019 and 2024. This section describes observed election movement only and is not a causal explanation.
- has manual markdown: False

## Writing prompts

- **what_happened_prompt**: Describe observed 2019→2024 election movement for Kannauj, Uttar Pradesh using winner, vote-share, margin, and turnout fields only.
- **why_it_mattered_prompt**: Explain why Kannauj may be analytically useful using priority reason (seat_flip), contest closeness, swings, and state context.
