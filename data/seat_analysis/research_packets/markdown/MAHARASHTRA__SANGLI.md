# Research packet: Sangli, Maharashtra

_Generated 2026-06-22. Evidence-backed prompts only; no invented local facts._

## Identity
- State: Maharashtra (`MAHARASHTRA`)
- Constituency: Sangli (`SANGLI`)

## Election facts (2019 → 2024)
- Winner 2019: Sanjaykaka Patil
- Winner 2024: VISHAL (DADA) PRAKASHBAPU PATIL
- Party 2019: BJP
- Party 2024: IND
- Winner changed: True
- BJP vote share 2019: 42.7742
- BJP vote share 2024: 40.3521
...
- Margin 2019: 13.8116
- Margin 2024: 8.5607
- Margin change: -5.2509
- Turnout 2019: 28.1351
- Turnout 2024: 30.5
- Turnout change: 2.3649
...
- winner_2024: VISHAL (DADA) PRAKASHBAPU PATIL
...
- generated summary: Sangli flipped from BJP to IND in 2024. BJP vote share changed by -2.4 points compared with 2019. The 2024 margin was 8.6%. This is a descriptive election profile, not a causal explanation.
- generated movement: Available data indicates Sangli flipped from BJP to IND between 2019 and 2024. BJP vote share changed by -2.4 percentage points versus 2019. The winning margin moved from 13.8% in 2019 to 8.6% in 2024. Turnout changed by +2.4 percentage points between 2019 and 2024. This section describes observed election movement only and is not a causal explanation.
- has manual markdown: False

## Writing prompts

- **what_happened_prompt**: Describe observed 2019→2024 election movement for Sangli, Maharashtra using winner, vote-share, margin, and turnout fields only.
- **why_it_mattered_prompt**: Explain why Sangli may be analytically useful using priority reason (seat_flip), contest closeness, swings, and state context.
